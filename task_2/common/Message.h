 ...
 * только ради Q_ENUM (нужен Q_GADGET), чтобы это перечисление средствами
 * Qt превращать в строки. Потом я вспомнил, что в зависимости от версии это
 * может оказаться числом и всё сломается, оставил числа, но оформление менять не стал.
 * В идеале сюда можно все хелперы сложить, как в namespace.
 */
class Message
{
    Q_GADGET
